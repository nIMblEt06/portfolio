...
function TestimonialCard(props) {
  return (
    <Box position={"relative"} flexShrink={0} bgColor="#121212" color= "#EEE3D3" padding="1.2rem" borderRadius={"24px"} w="25rem">
       ...
       {props.text}
        ...
        <Flex mt="1.4rem">
          <Link target={"_blank"} href={props.linkedin}><Image w="1.6rem" marginRight={"0.6rem"} src={linkedin}/></Link>
          <Link target={"_blank"} href={props.twitter}><Image w="1.6rem" src={twitter}/></Link>
        </Flex>
    </Box>
  )
}
